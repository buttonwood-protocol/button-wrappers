...
task('deploy:ButtonTokenWamplRouter')
  ...
  .setAction(async function(
    ...
    const ButtonTokenWamplRouter = await hre.ethers.getContractFactory('ButtonTokenWamplRouter');
    ...
    console.log(`ButtonTokenWamplRouter deployed to ${buttonTokenWamplRouterAddress}`);

    try {
      await hre.run('verify:ButtonTokenWamplRouter', { address: buttonTokenWamplRouterAddress, wampl });
    } catch (e) {
