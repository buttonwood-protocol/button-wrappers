...
task('deploy:ButtonTokenWethRouter')
  ...
  .setAction(async function(
    ...
    const ButtonTokenWethRouter = await hre.ethers.getContractFactory('ButtonTokenWethRouter');
    ...
    console.log(`ButtonTokenWethRouter deployed to ${buttonTokenWethRouterAddress}`);

    try {
      await hre.run('verify:ButtonTokenWethRouter', { address: buttonTokenWethRouterAddress, weth });
    } catch (e) {
