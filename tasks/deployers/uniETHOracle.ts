...
task('deploy:UniETHOracle')
  .addParam('rockxstaking', 'the RockXStaking oracle address', undefined, types.string, false)
...
task('verify:UniETHOracle', 'Verifies on etherscan')
  .addParam('address', 'the contract address', undefined, types.string, false)
  .addParam('rockxstaking', 'the RockXStaking contract address', undefined, types.string, false)
  .setAction(async function (args: TaskArguments, hre) {
